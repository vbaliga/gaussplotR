...
The function `fit_gaussian_2D()` uses `stats::nls()` to find the best-fit 
parameters of a 2D Gaussian fit to supplied data. 
...
plotting frameworks such as `lattice::levelplot()`.
