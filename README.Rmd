...
[![Travis build status](https://travis-ci.org/vbaliga/gaussplotR.svg?branch=master)](https://travis-ci.org/vbaliga/gaussplotR)
...
At this time, parameters of the Gaussian will need to be known in advance. 
The function `predict_gaussian_2D()` can then be used to predict values from
...
Baliga, VB. 2020. gaussplotR: Predict and plot 2D gaussians in R. figshare.
Software. https://doi.org/10.6084/m9.figshare.12980717
